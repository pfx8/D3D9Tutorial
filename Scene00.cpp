...
Scene00::Scene00()
{
	...
	// 光方向ベクトルを設定
	m_shader->m_effectPoint->SetVector(m_shader->m_lightingHandle, &D3DXVECTOR4(0.0f, 1.0f, -1.0f, 0.0f));
	...
	m_camera = new Camera();
	m_camera->InitCamera(
		m_hero->m_pos + D3DXVECTOR3(0.0f, 30.0f, -50.0f),	// Eye
		m_hero->m_pos + D3DXVECTOR3(0.0f, 8.0f, 0.0f),		// At
...
void Scene00::Update()
{
	...
	m_camera->UpdateAt(m_hero->m_pos);		// カメラ更新
	m_camera->Update();
